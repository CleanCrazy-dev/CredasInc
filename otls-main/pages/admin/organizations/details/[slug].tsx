...
interface OrganizationDetailsProps extends SEOProps {
  statusCode: number;
...
const OrganizationDetailsPage: NextPage<OrganizationDetailsProps> = (props) => {
  const router = useRouter();
  const { slug: organizationId } = router?.query || {};
  const organization = dumbData[Number(organizationId)];
  const subLinks: TabLink[] = [
    ...
    {
      url: `/admin/organizations/custodial-privacy-protection/${organizationId}`,
      label: i18n._(/*i18n*/ "Custodial Privacy Protection"),
    },
  ];
  ...
  const membersData = new Array(10).fill(0).map((_) => ({
    name: "Raymond Holt",
    role: "Captain",
    email: "rholt@b99.com",
    phone: "(123) 456-7890",
      ...
      <div className="container mt-16px">
        ...
        >
          ...
          >
            ...
            <span className="ml-8px" data-testid="organization-detail">
      ...
      <div className="container">
        <div className="d-flex justify-content-between align-items-center mt-16px">
          ...
          <button className="btn btn-primary">
            {i18n._(/*i18n*/ "Update Subscription")}
          </button>
        </div>
      </div>
      ...
      <div className="container">
        <div className={combineCSSClasses("row", styles["grey-card"])}>
          <div className="col-12">
            <p className={combineCSSClasses("text-semibold", styles["title"])}>
              {i18n._(/*i18n*/ "One Year Subscription")}
            </p>
          </div>
          <div className="col-3">
            <div className={styles["simple-card-item"]}>
              <p className={styles.label}>{i18n._(/*i18n*/ "Members")}</p>
              <span
                className={combineCSSClasses(
                  "text-primary",
          ...
          <div className="col-3">
            <div className={styles["simple-card-item"]}>
              <p className={styles.label}>{i18n._(/*i18n*/ "Next Payment")}</p>
              <span
                className={combineCSSClasses(
                  "text-primary",
                  styles["value-content"]
          ...
          <div className="col-3">
            <div className={styles["simple-card-item"]}>
              <p className={styles.label}>{i18n._(/*i18n*/ "Due On")}</p>
              <span
                className={combineCSSClasses(
                  "text-primary",
                  styles["value-content"]
          ...
          <div className="col-3">
            <div className={styles["simple-card-item"]}>
              <p className={styles.label}>
                {i18n._(/*i18n*/ "Subscription Ends On")}
              </p>
              <span
                className={combineCSSClasses(
                  "text-primary",
        ...
        <div className="row">
          ...
          <div className="col-6">
            ...
            <div className="row pt-8px">
              ...
              <div className="col-9">
                <DropdownList defaultValue={organization?.type}>
            ...
            <div className="row pt-8px">
              ...
              <div className="col-9">
                <DropdownList defaultValue={organization?.created_by}>
                  <option value={organization?.created_by}>
            ...
            <div className="row pt-8px">
              ...
              <div className="col-9">
                <input
                  type="text"
                  className={combineCSSClasses(styles["input"])}
                  defaultValue={organization?.main_contact}
                />
              </div>
            </div>
            <div className="row pt-8px">
            ...
            <div className="row pt-8px">
              ...
              <div className="col-9">
                <input
                  ...
                  defaultValue={organization?.address?.value}
                />
                <div className="row pt-8px">
      ...
      <div className="container mt-16px">
        ...
        >
          ...
          <button
            ...
            onClick={handleNewMemberClicked}
          >
...
export const getStaticPaths: GetStaticPaths = async ({ locales }) => {
  const organizations = dumbData;
  const paths: StaticPath[] = organizations.map((_, index) => ({
    params: { slug: `${index}` },
    locale: "en",
  }));
  return {
...
export const getStaticProps: GetStaticProps = async (
  ctx
): Promise<{ props: OrganizationDetailsProps }> => {
  let statusCode = 200;
